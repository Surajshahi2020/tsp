        ...
        <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
            <div class="d-flex justify-content-between col-lg-8 col-sm-12">
                <a class="navbar-brand" href="?">
                    <img src="assets/images/a.png" alt="" height="28">
    ...
    <?php
                ...
                <li class="nav-item dropdown dropstart">
                    ...
                    <li><a class="dropdown-item" href="?u=<?=$user['username']?>"><i class="bi bi-person"></i> My Profile</a></li>
                        ...
                        <script src="https://kit.fontawesome.com/84fa699235.js" crossorigin="anonymous"></script>

                          <li><a class="dropdown-item" href="http://localhost/videocall/"><i class="fas fa-video"></i> Live Stream</a></li>
                         

                          <li><a class="dropdown-item" href="http://localhost/map/user-map.php"><i class="fa fa-map-marker" aria-hidden="true"></i> Map</a></li>
